...
def main(cfg: DiarizationConfig) -> Union[DiarizationConfig]:
    ...
    if args.asr_model.endswith('.nemo'):
        ...
        model_cfg.freeze_diar = True
        model_cfg.soft_decision = False
        model_cfg.gt_decision = False
        ...
        asr_model = nemo_asr.models.EncDecRNNTBPEQLTSASRModel.from_pretrained(model_name=args.asr_model)
